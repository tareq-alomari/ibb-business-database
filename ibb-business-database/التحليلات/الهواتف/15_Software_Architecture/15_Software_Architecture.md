# المرحلة الخامسة عشرة: 15_Software_Architecture - قطاع الهواتف والاتصالات في محافظة إب
...
## 15.1 النمط المعماري
**Clean Architecture + Microservices** لمنصة قطاع الهواتف والاتصالات في إب
