# المرحلة السادسة عشرة: Technical Stack - قطاع المطاعم في محافظة إب
...
| Next.js | 14 | SSR، تحسين SEO، أداء عال |
...
| Google Maps Flutter | - | خرائط وتتبع |
...
| التقنية | الغرض |
|---------|-------|
| Cloudflare R2 | تخزين صور المطاعم والمنيو |
...
| لغة Backend | TypeScript/Node | Python | TypeScript/Node | نفس لغة الواجهة، سرعة، مجتمع |
| ORM | Prisma | TypeORM | Prisma | تجربة مطور أفضل، أمان أنواع |
| Database | PostgreSQL | MySQL | PostgreSQL | JSONB، Full-text search، spatial |
| Storage | S3 | R2 | R2 | تكلفة صفرية للخروج (egress) |
| CI/CD | GitHub Actions | GitLab CI | GitHub Actions | تكامل مع GitHub |
...
## 16.4 إدارة الاعتماديات (Dependency Management)

| المنصة | أداة إدارة الاعتماديات |
|--------|----------------------|
| Node.js | npm / yarn.lock |
| Flutter | pubspec.lock |
| Python (اختياري) | poetry / pip |
...
| المكون | الرخصة |
|--------|--------|
| كود المشروع | Proprietary (حقوق محفوظة) |
| React | MIT |
| Next.js | MIT |
| Flutter | BSD-3 |
...
- Cloudflare R2 Documentation (cloudflare.com/r2)