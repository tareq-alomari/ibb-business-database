# المرحلة الخامسة عشرة: 15_Software_Architecture - قطاع الوزارات والدوائر الحكومية في محافظة إب
...
## 15.1 النمط المعماري
**Clean Architecture + Microservices** لمنصة قطاع الوزارات والدوائر الحكومية في إب
