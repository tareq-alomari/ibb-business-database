# المرحلة الرابعة عشرة: API Design - قطاع البيطرة في محافظة إب
...
| GET/POST | `/veterinarians` | إدارة veterinarians |
| GET/POST | `/clinics` | إدارة clinics |
| GET/POST | `/animals` | إدارة animals |
| GET/POST | `/vaccinations` | إدارة vaccinations |
| GET/POST | `/appointments` | إدارة appointments |
| GET/POST | `/consultations` | إدارة consultations |
| GET/POST | `/products` | إدارة products |
| GET/POST | `/health-records` | إدارة health-records |
