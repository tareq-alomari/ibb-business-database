# المرحلة الرابعة عشرة: API Design - قطاع البلديات في محافظة إب
...
| GET/POST | `/projects` | إدارة projects |
| GET/POST | `/complaints` | إدارة complaints |
| GET/POST | `/payments` | إدارة payments |
| GET/POST | `/documents` | إدارة documents |
| GET/POST | `/announcements` | إدارة announcements |
