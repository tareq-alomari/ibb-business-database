# المرحلة الخامسة عشرة: 15_Software_Architecture - قطاع النقل بين المحافظات في محافظة إب
...
## 15.1 النمط المعماري
**Clean Architecture + Microservices** لمنصة قطاع النقل بين المحافظات في إب
