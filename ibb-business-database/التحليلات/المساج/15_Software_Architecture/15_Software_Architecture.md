# المرحلة الخامسة عشرة: 15_Software_Architecture - قطاع المساج والعلاج الطبيعي في محافظة إب
...
## 15.1 النمط المعماري
**Clean Architecture + Microservices** لمنصة قطاع المساج والعلاج الطبيعي في إب
