# المرحلة الرابعة عشرة: API Design - قطاع التخليص في محافظة إب
...
| GET/POST | `/offices` | إدارة offices |
| GET/POST | `/shipments` | إدارة shipments |
| GET | `/categories` | إدارة categories |
| GET/POST | `/fees` | إدارة fees |
| GET/POST | `/documents` | إدارة documents |
| GET/POST | `/tracking` | إدارة tracking |
| GET/POST | `/payments` | إدارة payments |
| GET/POST | `/regulations` | إدارة regulations |
