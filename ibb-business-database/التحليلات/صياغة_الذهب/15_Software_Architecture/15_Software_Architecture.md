# المرحلة الخامسة عشرة: 15_Software_Architecture - قطاع صياغة الذهب والمجوهرات في محافظة إب
...
## 15.1 النمط المعماري
**Clean Architecture + Microservices** لمنصة قطاع صياغة الذهب والمجوهرات في إب
