# المرحلة الخامسة عشرة: 15_Software_Architecture - قطاع صيانة الأجهزة الإلكترونية في محافظة إب
...
## 15.1 النمط المعماري
**Clean Architecture + Microservices** لمنصة قطاع صيانة الأجهزة الإلكترونية في إب
