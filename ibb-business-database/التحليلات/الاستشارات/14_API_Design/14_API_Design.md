# المرحلة الرابعة عشرة: API Design - قطاع الاستشارات في محافظة إب
...
| GET/POST | `/consultants` | إدارة consultants |
...
| GET/POST | `/contracts` | إدارة contracts |
| GET/POST | `/payments` | إدارة payments |
| GET/POST | `/messages` | إدارة messages |
